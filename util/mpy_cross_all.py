...
'''
This file was vendored from MicroPython to make compiling KMK more feasible on Windows,
which doesn't have easy access to Make. This file is licensed with the permissive MIT
license.
